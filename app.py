...
with st.sidebar:
    st.header("Model:")
    checkpoint = st.selectbox("Model", options=["Choose model", "Salesforce/codet5p-220m-py", "Salesforce/codet5p-770m-py", "dtruong46me/codet5p-220m", "dtruong46me/codet5p-770m-lora", "dgktrnh/finetuned-codet5p-770m"])
